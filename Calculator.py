...
#first we need to import tkinter from the python library in order to use it 

window=Tk()
#create a window variable and assign all tkinter library to it 

window.geometry("350x500")
#change the size of our application

window.title("calculator")

window.configure(bg='#3399ff')
# the name of our calculator
window.iconbitmap("calc.png")
